...
// Vendor the lock-suffix golden so test/min-simple-bolt.template.test.ts runs without the sibling sx/.
writeFileSync(resolve(PKG, 'test/fixtures/MinSimpleBolt.lockSuffix.hex'), lockHex)
